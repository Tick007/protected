...
return array (
				...
				*/
				...
				'urlManager' => array (
						...
						'rules' => array (
								...
								*/
								//'yii/<controller:\w+>/<id:\d+>' => '<controller>/view',
				...
				'db' => array (
						'class' => 'CDbConnection',
						'connectionString' => 'mysql:host=localhost;dbname=u0254849_default',
						// 'username'=>'psg-root',
						// 'password'=>'H7dSLyB64.G',
						'username' => 'u0254849_default',
						'password' => 'hN74.Fgr',
		...
		'params' => array (
				...
				'supportEmail' => 'a.kravtsov1987@gmail.com',
				'display_error' => true,
				'self_contragent' => 1,
				...
				'cart' => array (
						...
						'rules' => array ( // ///Пробелы убрать
								'nomail' => array (
										'first_name,client_email,client_email_copy,client_tels,delivery,payment,client_city',
										'required',
										'on' => 'nomail' 
								),
								'mail' => array (
										'first_name,second_name,client_email,client_email_copy,client_tels,delivery,payment,last_name,client_post_index,client_city',
										'required',
										'on' => 'mail' 
								) 
						) 
			...
			'simplatools'=>array(
					'productDescriptionsFolder'=>array('path'=>$_SERVER['DOCUMENT_ROOT'].'/files/descriptions/', 'url'=>'/files/descriptions/'),
					'productDescriptionsImg'=>array('path'=>$_SERVER['DOCUMENT_ROOT'].'/files/descriptions/dimages/', 'url'=>'/files/descriptions/dimages/'),
			),
		) ,
