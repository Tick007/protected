	...
	'components'=>array(
		...
		*/
		...
		'urlManager'=>array(
			...
			//'technics/domestic/<path:[\w+-\/]{0,}\w+>/<alias:\w+>/<pd:\d+>'=>'product/details',
			//'technics/domestic/<cat:\d+>/<pd:\d+>'=>'product/details',
			'technics/domestic/<pd:\d+>'=>'product/details',
			...
			'technics/<id:\d+>'=>'product/list',
			
			
			'pagina/<id:\w+>'=>'page/byalias',
			'news/list'=>'page/list',
		...
		'connectionString'=>'mysql:host=localhost;dbname=u1424315_homesgoods',
