...
return array(
	...
	'name'=>'Автомобильные противоугонные системы',
	//'theme'=>'protuning', 
	//'theme'=>'bogajniki',
	'theme'=>'fortus_new3',
	//'theme'=>'wood', 
	...
	'components'=>array(
		...
		*/
		...
		//	'regions/<regid:\d+>'=>'page/show',
			...
			//Раздел партнеры
			'partners/tools/<id:\d+>'=>'constructcatalog/tools',
			'partners/tools'=>'constructcatalog/tools',
			
					
			
			'catalog/gettext'=>'constructcatalog/gettext',
			'catalog/<locktype:\w+>/<krepltype:(kpp|val|hood|hoodset|garage|pricep|headlamp|sparetire)>/<view:(break|hmini|classic|contra)>'=>'constructcatalog/index',
			
			'catalog/search/<locktype:\w+>/<krepltype:(kpp|val|hood|hoodset|garage|pricep|headlamp|sparetire|alltype|electromeh|pinlessval|0)>'=>'constructcatalog/search',///////
		...
		*/
		...
		'connectionString'=>'mysql:host=127.0.0.1;dbname=fortus',
		'username'=>'root',
		'password'=>'1234',
