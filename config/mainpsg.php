...
return array(
	...
	'components'=>array(
		...
		*/
		...
		'urlManager'=>array(
			...
			//оплата тинькофф (не сделана, т.к. эдик отказался делать платно, а поддержки больше нет)
		...
		'db'=>array(
		'class'=>'CDbConnection',
		'connectionString'=>'mysql:host=localhost;dbname=u0842566_default',
		//'username'=>'psg-root',
		//'password'=>'H7dSLyB64.G',
		'username'=>'u0842566_default',
		'password'=>'hc4Nh2qX',
	...
	'params'=>array(
		...
		'delivery_samovivoz'=>array(8600, 8601),
		'main_tree_root'=>0,
		...
		'cart'=>array(
			...
			'product_yii_path'=>'product/details',
			'product_id_label'=>'pd',
			'labels'=>array(
			...
			'rules'=>array(
				'nomail_old'=>array('first_name, client_email, client_email_copy, client_tels, delivery_method, payment_method, client_city, client_street, client_house, client_apart', 'required','on'=>'nomail'),
					'nomail'=>array('first_name, second_name, last_name, client_email, client_email_copy, client_tels, delivery, payment, client_city ', 'required','on'=>'nomail'),
