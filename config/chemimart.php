   ...
   'defaultController' => 'chemimart',
	    ...
	    'urlManager'=>array(
	        ...
	        'rules'=>array(
	           ...
	           // '/' => 'chemimart/index',
	            ...
	            'catalog/<alias:\w+>/<palias:\w+>-p<id:\d+>'=>'catalog/info', ////////////Антон попросил сделать урлы 12.02.2020
	...
	//	),
		...
		'db'=>array(
			...
			'charset' => 'utf8',
		    */
		    'connectionString'=>'mysql:host=127.0.0.1;dbname=chemimart',
		    'username'=>'root',
		    'password'=>'1234',
		    'charset' => 'utf8',
	...
	'params'=>array(
	    ...
	    'adminEmail'=>array('info@chemimart.de', 'tick007@yandex.ru'), ////////////Может быть массивом  Кому слать
	    'infoEmail'=>'info@chemimart.de', /////////////От кого слать
	    ...
	    'inetpayment'=>array(
	        ...
	        'getawayurl'=>'http://paysystem/payment/pay',
	        'login'=>'chemimart',
	        'shop_id'=>2,
	    ...
	    'catalog'=>(object)array('desktopItemsNum'=>12),
