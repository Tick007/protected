...
return array(
    ...
    'components'=>array(
        ...
        'urlManager'=>array(
            ...
            'rules'=>array(
              ...
              //  'catalog/<locktype:\w+>/<krepltype:(kpp|val|hood|garage|pricep|headlamp|sparetire|hoodmodel)>/<view:(break|hmini|classic|contra)>'=>'constructcatalog/index',
                
                'catalog/search/<locktype:\w+>/<krepltype:(kpp|val|hood|hoodset|garage|pricep|headlamp|sparetire|alltype|electromeh|pinlessval|controlblock|hoodmodel|0)>'=>'constructcatalog/search',///////
                
                'zamki/<locktype:\w+>/<krepltype:(kpp|val|hood|hoodset|garage|pricep|headlamp|sparetire|hoodmodel)>'=>'constructcatalog/zamki',
                ...
                'catalog/<locktype:\w+>/<krepltype:(kpp|val|hood|garage|pricep|headlamp|sparetire|electromeh|pinlessval|hoodmodel)>/<path:[\w+-\/]{0,}\w+>/<alias:[\w+-]{0,}\w+>/<id:\d+>'=>'constructcatalog/info',///////товар
                'catalog/<locktype:\w+>/<path:[\w+-\/]{0,}\w+>/<alias:[\w+-]{0,}\w+>/<id:\d+>'=>'constructcatalog/info',////////товар
                
                'catalog/<locktype:\w+>/<krepltype:(kpp|val|hood|garage|pricep|headlamp|sparetire|electromeh|pinlessval|hoodmodel)>/<path:[\w+-\/]{0,}\w+>/<alias:[\w+-]{0,}\w+>'=>'constructcatalog/group',///////
                'catalog/<locktype:\w+>/<krepltype:(kpp|val|hood|garage|pricep|headlamp|sparetire|electromeh|pinlessval|hoodmodel)>/<alias:[\w+-]{0,}\w+>'=>'constructcatalog/group',///////
                */
                
               // 'catalog/<locktype:\w+>/<krepltype:(kpp|val|hood|garage|pricep|headlamp|sparetire|electromeh|pinlessval|hoodmodel)>'=>'constructcatalog/index',
    ...
    'params'=>array(
        ...
        'yml_visible_condition'=>array(
            'products'=>"  t.product_visible = 1 AND belong_category.show_category=1 ",
            ),
        ...
        'typs_krepleniya'=>array(
            'kpp'=>'КПП',
            'hood'=>'Капота',
            'hoodmodel'=>'Замки капота модельные',
            'hoodset'=>'Подкапотный комплект',
