...
return array(
	...
	'components'=>array(
		...
		*/
		...
		'password'=>'1234',
		*/
		'connectionString'=>'mysql:host=localhost;dbname=u0534213_default',
		'username'=>'u0534213_default',
		'password'=>'jfh7!bNDDrL',
		/*
	...
	'params'=>array(
		...
		'infoEmail'=>'info@pnevmoinstrument.ru', 
		...
		'use_long_urls'=>true,
		'cart'=>array(
			'private_face'=>array('client_email', 'client_email_copy', 'client_tels', 'second_name','first_name'),
			'private_face_mail'>=array('client_email', 'client_email_copy', 'client_tels', 'second_name', 'first_name', 'last_name', 'client_post_index'),
			'rules'=>array(
				'oneclick'=>array(
					'required'=>array('email', 'required'), 
					'safe'=>array('name, tel, city', 'safe'), 
				),
			),
		),
	),
