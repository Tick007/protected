...
return array(
	...
	'name'=>'Компоненты для тюнинга',
	//'theme'=>'trade-x',
	'theme'=>'tuningequipment', 
	...
	'components'=>array(
		...
		*/
		...
		'urlManager'=>array(
			...
			'tuning/<path:[\w+-\/]{0,}\w+>/<alias:\w+>/<pd:\d+>'=>'product/details',
			'tuningpart/<cat:\d+>/<pd:\d+>'=>'product/details',
			...
			'tuning/<id:\d+>'=>'product/list',
			
			
			'article/<id:\w+>'=>'page/byalias',
			'news/list'=>'page/list',
