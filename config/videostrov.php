...
return array(
	...
	'name'=>'Каталог электроники ВидеоОстров',
	//'theme'=>'trade-x',
	//'theme'=>'videostrov', 
	'theme'=>'enterteh_nofoto',   
	...
	'components'=>array(
		...
		*/
		...
		'urlManager'=>array(
			...
			'b08e7449c7fba1182de7d253c8188832/template.php'=>'page/sapearticle', 

			'product/<path:[\w+-\/]{0,}\w+>/<alias:\w+>/<pd:\d+>'=>'product/details',
			'product/<cat:\d+>/<pd:\d+>'=>'product/details',
		...
		'connectionString'=>'mysql:host=localhost;dbname=u1424315_videostrov_new',
