...
return array (
		...
		'components' => array (
				...
				*/
				...
				'db' => array (
						'class' => 'CDbConnection',
						'connectionString' => 'mysql:host=localhost;dbname=odinsifo_soda_db',
						// 'username'=>'psg-root',
						// 'password'=>'H7dSLyB64.G',
						'username' => 'odinsifo_n',
						'password' => 'Fyen7!.f_she',
		...
		'params' => array (
				...
				'payment_matching'=>array(
						'1sifon.ru'=>array(1=>13, 2=>12),
						),
				'delivery_matching'=>array(
						'1sifon.ru'=>array(
								1=>array('id'=>'1', 'price'=>'250'),
								2=>array('id'=>'3', 'price'=>'350'), 
								3=>array('id'=>'4', 'price'=>'0')),
						),
		) 
)
;
