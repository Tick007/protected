...
echo CHtml::beginForm(array('/adminreports/stores_series/'),  $method='post',$htmlOptions=array('name'=>'report_form', 'id'=>'report_form'));  
?>
<div id="ribbon">&nbsp;</div>
