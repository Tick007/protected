...
<?
echo CHtml::beginForm(array('/adminprices/list/'),  $method='post',$htmlOptions=array('name'=>'listparams'));  
?>
<tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr bgcolor="#666E73">
    ...
    <th align="left" scope="col"><span class="стиль1">Тип цен</span></th>
    <th align="left" scope="col"><span class="стиль1">Валюта</span></th>
  ...
  ?>
  <tr>
    <td><?php echo CHtml::link($models[$i]->id, array('/adminprices/', 'pricelist'=>$models[$i]->id), $htmlOptions=array ('encode'=>false) )?> 
    &nbsp;&nbsp;&nbsp;&nbsp;
    <?php echo CHtml::link($models[$i]->id, array('/adminprices/stepone', 'id'=>$models[$i]->id), $htmlOptions=array ('encode'=>false) )?>
    </td>
    <td><?
    echo $models[$i]->creation_dt;
	?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><?
    echo $models[$i]->currencies->currency_code;
	?></td>
    <td><?
    if (@$models[$i]->status==1) echo "<img src=\"/images/apply.png\">";
