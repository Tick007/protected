...
class NumToText
{
	...
	function DescrSot(&$in, $raz, $ar_descr, $fem = false)
	{
		...
		if($conv >= 100)
		{
			$Sot = array(' сто', ' двести', ' триста', ' четыреста', " пятьсот",  ////////////TODO///Портится число при выводе  ��ятьсот рублей 00 копеек, пропадает буква п
	...
	function Convert_half($sum) //просто разбиваем на рубли и копейки
	{
		$ret = '';
