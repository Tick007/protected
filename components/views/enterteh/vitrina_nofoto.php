  ...
  <div id="wrapper">
	...
	for ($i=0; $i<count($products); $i++) {
        ...
        <li><div style="height:150px; overflow:hidden; width:144px;"><?php
							...
							$iconname ='http://'.Yii::app()->params['pictures_sourse']."/pictures/add/icons/".$products[$i]->icon_id.'.png';
									...
									echo CHtml::link("<img src=\"$iconname\"  style=\"max-width:150px; max-height:150px\" />", $url);
