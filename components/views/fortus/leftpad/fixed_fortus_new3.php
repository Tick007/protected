...
//////хз, но тут включение отвалилось
//$clientScript = Yii::app()->clientScript;
//$clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/themes/fortus_new3/js/chosen/chosen.jquery.js', CClientScript::POS_HEAD);
//$clientScript->registerCssFile(Yii::app()->request->baseUrl . '/themes/fortus_new3/js/chosen/chosen.css?v='.rand(), 'screen');
...
<a href="/themes/fortus/manuals/hl_razriv.pdf" target="_blank" style="color: #993333;">ИНСТРУКЦИЯ ПО МОНТАЖУ HL  «в разрыв»</a><br>
<a href="/themes/fortus/manuals/hl_counter_move.pdf" target="_blank" style="color: #993333;">ИНСТРУКЦИЯ ПО МОНТАЖУ HL  «в противоход»</a> <br>
<a href="/themes/fortus/manuals/hl_classic.pdf" target="_blank" style="color: #993333;">ИНСТРУКЦИЯ ПО МОНТАЖУ HL Classic</a><br>
<a href="/themes/fortus/manuals/hl_classic-mini.pdf" target="_blank" style="color: #993333;">ИНСТРУКЦИЯ ПО МОНТАЖУ HL Classic mini</a>
-->
