  ...
  <div id="wrapper">
	...
	if(is_file($fname) AND file_exists($fname) AND file_exists($fname_icon) ) {
        ...
        <div class="carousel_pprice">
        		<span><?php echo str_replace(',00', '', FHtml::encodeValuta($products[$i]->product_price, ''))?></span><span class="rouble2">a</span>&nbsp;&nbsp;&nbsp;
        </div>
        </li>
