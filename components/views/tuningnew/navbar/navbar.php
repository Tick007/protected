          ...
          <li class="nav-custom-link level0 level-top parent"> <a class="level-top" href="#"><span>BRANDS</span></a>
            <div class="level0-wrapper custom-menu" style="left: 0px; display: none;">
              <div class="header-nav-dropdown-wrapper clearer">
                <div class="grid12-5">
                  <div class="custom_img"><a href="<?php echo Yii::app()->createUrl('product/vendor', array('alias'=>'ТехноМастер'))?>">
                  <img src="<?php echo Yii::app()->theme->baseUrl?>/images/brandlogo/tehnomaster.jpg" alt="custom img1"></a></div>
                  <p>ТехноМастер</p>
                <!--   <button class="learn_more_btn" title="В корзину" type="button"><span>ТехноМастер</span></button>-->
                </div>
                <div class="grid12-5">
                  <div class="custom_img"><a href="<?php echo Yii::app()->createUrl('product/vendor', array('alias'=>'Pro_Sport'))?>">
                  <img src="<?php echo Yii::app()->theme->baseUrl?>/images/brandlogo/prosport.jpg" alt="custom img2"></a></div>
                  <p>Проспорт</p>
                <!--   <button class="learn_more_btn" title="В корзину" type="button"><span>Проспорт</span></button>-->
                </div>
                <div class="grid12-5">
                  <div class="custom_img"><a href="<?php echo Yii::app()->createUrl('product/vendor', array('alias'=>'ss20'))?>">
                  <img src="<?php echo Yii::app()->theme->baseUrl?>/images/brandlogo/ss20.jpg" alt="custom img3"></a></div>
                  <p>SS20</p>
                <!--   <button class="learn_more_btn" title="В корзину" type="button"><span>SS20</span></button>-->
                </div>
                <div class="grid12-5">
                  <div class="custom_img"><a href="<?php echo Yii::app()->createUrl('product/vendor', array('alias'=>'Lada'))?>">
                  <img src="<?php echo Yii::app()->theme->baseUrl?>/images/brandlogo/lada.jpg" alt="custom img4">
                  </a></div>
                  <p>LADA</p>
                  <!--  <button class="learn_more_btn" title="В корзину" type="button"><span>LADA</span></button>-->
                </div>
              </div>
            </div>
          </li>
